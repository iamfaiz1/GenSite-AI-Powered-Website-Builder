    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          >
            <div className='relative overflow-hidden rounded-[2rem] bg-[#0f0f0f] border border-white/10 shadow-2xl p-7'>
              ...
              <div className='relative z-10 flex flex-col items-center text-center'>
                ...
                <motion.button 
                  ...
                  whileTap={{ scale: 0.98 }}
                  className='w-full max-w-[280px] flex items-center justify-center gap-3 px-5 py-2.5 rounded-xl border border-white/10 text-white text-sm font-medium transition-all bg-white/5'
                >
                  <img 
